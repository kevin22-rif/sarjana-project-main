<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="occupation" class="border block py-2 pl-3 mt-1 w-full" type="text" name="occupation"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="bank_name" class="border block py-2 pl-3 mt-1 w-full" type="text" name="bank_name"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="bank_account" class="border block py-2 pl-3 mt-1 w-full" type="text"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="bank_account_number" class="border block py-2 pl-3 mt-1 w-full" type="number"
